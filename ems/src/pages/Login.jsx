...
const Logo = () => (
  <div className="flex items-center justify-center space-x-3 mb-6">
    <div className="w-12 h-12 rounded-2xl flex items-center justify-center">
      <img src={LogoImg} alt="Logo" className="w-full h-full object-contain drop-shadow-[0_0_8px_rgba(45,212,191,0.5)]" />
    </div>
    <div>
      <h1 className="text-2xl font-bold bg-gradient-to-r from-teal-600 to-emerald-600 bg-clip-text text-transparent">WorkBuff</h1>
...
const FormWrapper = ({ children, title, subtitle, error, successMsg }) => (
  <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 px-4 py-8">
    <div className="w-full max-w-md">
      ...
      <p className="text-center text-xs text-gray-400 mt-6">© 2026 WorkBuff. Made by Adnan</p>
    </div>
  </div>
);
