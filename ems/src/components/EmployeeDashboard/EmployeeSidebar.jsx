...
import LogoImg from '../../assets/infinity.png';
...
const EmployeeSidebar = () => {
    ...
    const links = [
        ...
        { to: '/employee-dashboard/profile', icon: <FaUser />, label: 'My Profile' },
        { to: '/employee-dashboard/attendance', icon: <FaClipboardList />, label: 'Attendance' },
    ...
    return (
        <div className="bg-gradient-to-b from-gray-900 to-gray-800 text-white h-screen fixed left-0 top-0 w-64 flex flex-col shadow-2xl">
            ...
            <div className="px-6 py-6 border-b border-gray-700/50">
                <div className="flex items-center space-x-3">
                    <div className="w-10 h-10 rounded-xl flex items-center justify-center">
                        <img src={LogoImg} alt="Logo" className="w-full h-full object-contain drop-shadow-[0_0_8px_rgba(59,130,246,0.5)]" />
                    </div>
                    <div>
                        <h3 className="text-xl font-bold bg-gradient-to-r from-blue-400 to-indigo-300 bg-clip-text text-transparent">
                            Workbuff
                        </h3>
                        <p className="text-[10px] text-gray-500 uppercase tracking-widest">Employee Portal</p>
                    </div>
                </div>
            </div>
            ...
            <div className="px-5 py-4 border-b border-gray-700/30">
                <div className="flex items-center space-x-3">
                    <div className="w-9 h-9 rounded-full bg-gradient-to-br from-blue-500 to-indigo-500 flex items-center justify-center text-sm font-bold shadow-md">
                        {user?.name?.[0] || 'E'}
                    </div>
            ...
            <nav className="flex-1 px-3 py-4 space-y-1 overflow-y-auto">
              ...
              ${isActive
                                ? 'bg-gradient-to-r from-blue-500/20 to-indigo-500/10 text-blue-400 border border-blue-500/20 shadow-sm'
            ...
            <div className="px-3 pb-4">
                ...
                <p className="text-[10px] text-gray-500 text-center mt-3 opacity-60">Made by Adnan</p>
            </div>
        </div>
    );
};
